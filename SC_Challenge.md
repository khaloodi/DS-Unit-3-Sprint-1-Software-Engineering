...
In my opinion, code reviews are a way to improve skills and understanding of subject matter -both for the reviewer,
as well as for the person submitting their code. Something I pay attention to is how much feedback the reviewer provides
and where they place their feedback -whether it be in the body of the code or in a separate message/email. I appreciate
when the reviewer places their comments directly in the body of my code.
  
- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

Containers help to create a localized and portable environment that any user can pull onto their machine and run,
regardless of what OS their running or type of machine they have. Containers also ensure that all users are (initially) 
using the same frameworks with the same dependencies.
